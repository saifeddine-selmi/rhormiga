...
import { Employe } from 'src/app/admin/modal/employe';
import { EmpolyeService } from 'src/app/admin/services/empolye.service';
import jwt_decode from "jwt-decode";
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-update-info-emp',
  templateUrl: './update-info-emp.component.html',
  styleUrls: ['./update-info-emp.component.css']
})
export class UpdateInfoEmpComponent implements OnInit {
